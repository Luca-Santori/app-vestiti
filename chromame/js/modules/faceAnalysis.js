...
import { rgbToLab, rgbToHsl, rgbToHex, fitzpatrick, textColorFor } from '../utils/color.js';
 ...
 * @returns {string}
 */
export function classifyHair(L) {
 ...
 * @returns {string}
 */
export function classifyEye(h, s) {
 ...
 * @returns {string}
 */
export function seasonDecisionTree(undertone, contrast, skinL, hairL) {
  if (undertone === 'warm') {
    if (hairL > 65) {
 ...
 * @returns {number} 0–97
 */
export function computeConfidence(undertone, contrast, skinL, seasonName) {
