/* ══════════════════════════════════════════════════════
   MAIN — event handlers, upload zones, tab switching
   ══════════════════════════════════════════════════════ */

import { STATE, MAX_IMG_WIDTH } from './config.js';
import { loadImage, drawImageScaled } from './utils/image.js';
import { setLog } from './ui/progress.js';
import { runArmocromia } from './modules/armocromia.js';
import { runFaceAnalysis } from './modules/faceAnalysis.js';
import { runTryon } from './modules/tryon.js';
